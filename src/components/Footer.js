    ...
    return (
        <div>
            ...
            <footer className="bg-black mt-16 ">
                <div className="grid place-items-center grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
                    <div>
                ...
                <div className="py-6 px-4 bg-black  md:flex md:items-center md:justify-between">
                    <span className="text-sm text-gray-500  sm:text-center">© 2022 <a href="#">Bigslam™</a>. All Rights Reserved.
                    </span>
